...
// Local Spinner component for buttons
...
export const Icons = {
  ...
  Crown: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 3l4 6 3-6 3 6 4-6v13a2 2 0 01-2 2H7a2 2 0 01-2-2V3z" />
    </svg>
  ),
  ArrowUp: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  Play: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293H15M9 10v4a1 1 0 001 1h4M9 10V9a1 1 0 011-1h4a1 1 0 011 1v1M9 10H8a1 1 0 00-1 1v3a1 1 0 001 1h1m0-5h4m0 0v4m0-4h1a1 1 0 011 1v3a1 1 0 01-1 1h-1m-4-5V9" />
    </svg>
  ),
  TestTube: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // Missing icons for landing page
  FileText: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
// Enhanced Button component with polymorphic rendering
const Button = ({
  as: Component = 'button',
  variant = 'primary',
  size = 'md',
  ...
  const variants = {
    primary: 'bg-[#5A827E] hover:bg-[#5A827E]/90 text-white shadow-md hover:shadow-lg focus:ring-[#5A827E]/50',
    secondary: 'bg-[#84AE92] hover:bg-[#84AE92]/90 text-white shadow-md hover:shadow-lg focus:ring-[#84AE92]/50',
    accent: 'bg-[#B9D4AA] hover:bg-[#B9D4AA]/90 text-[#5A827E] shadow-md hover:shadow-lg focus:ring-[#B9D4AA]/50',
    outline: 'border-2 border-[#84AE92] text-[#5A827E] hover:bg-[#84AE92] hover:text-white focus:ring-[#84AE92]/50',
    ghost: 'text-[#5A827E] hover:bg-[#B9D4AA]/20 focus:ring-[#84AE92]/50',
  ...
  // Filter out button-specific props when rendering as Link
      ...
      {isLoading ? (
        ...
        <>
          {IconComponent && iconPosition === 'left' && (
            <div className={`${children ? 'mr-2' : ''} ${iconSizes[size]}`}>
              <IconComponent />
            </div>
          )}
          {children}
          {IconComponent && iconPosition === 'right' && (
            <div className={`${children ? 'ml-2' : ''} ${iconSizes[size]}`}>
              <IconComponent />
            </div>
          )}
        </>
...
export const FloatingActionButton = ({ icon: IconComponent, onClick, className = '', ...props }) => (
  <button
    onClick={onClick}
    className={`fixed bottom-6 right-6 w-14 h-14 bg-primary-500 hover:bg-primary-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 z-50 ${className}`}
    {...props}
  >
